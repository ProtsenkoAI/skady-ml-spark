...
class TestModelManager(unittest.TestCase):
    ...
    def test_save(self):
        ...
        save_name = assistant.save_packaged_model(saver)
    ...
    def test_load_from_save(self):
        ...
        save_name = assistant.save_packaged_model(saver)
        del assistant
        loaded_assist = LocalModelManager.from_save(saver, save_name)
        self.assertIsInstance(loaded_assist, LocalModelManager)
